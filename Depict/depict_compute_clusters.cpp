...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
 ...
 double *i3_closest_d=mxGetPr(prhs[4]); // input index of the closest voxel with higher density vector
...
/************************************** FIND CLUSTERS**************************************/
 ...
 int *i3_closest=new int[NC]; 

 for(i1=0; i1<NC; i1++) {
     i3_closest[i1]=(int)i3_closest_d[i1];
 }
