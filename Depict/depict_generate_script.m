...
%%%% SCIRPT NAME
 ...
 function okbuttonaction(varargin)
   ...
   fprintf(scriptfile,'outfname=[path ''/cluster_map_'' name ''_''];\n');
   fprintf(scriptfile,'\n');
   ...
   fprintf(scriptfile,'\tdepict_generate_output_nifti(outfname,The_files_to_cluster,The_mask,final_assignation,density,vol);\n');
