...
global NCLUST_MAX
 ...
 elseif(busy==1)
   ...
   outfname=[path '/depict_map_' name '_'];

   script_name_ui=uicontrol('Style','edit','string',outfname,'Units','normalized','Position',[0.05 0.85 0.7 0.05]);
   txt12 = uicontrol(fgApply,'Style','text','Units','normalized','Position',[0.75 0.855 0.2 0.03],'String','_xx_yy_zz.nii');
