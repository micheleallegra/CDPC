...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
 ...
 double *i3_closest=mxGetPr(plhs[2]); //for each voxel, the closest voxel with a higher density
...
//************************************** COMPUTES NUMBER OF COHERENT SPATIAL NEIGHBORS ********************************************// 
 ...
 //mexPrintf("finding number of coherent spatial neighbors \n");
 //mexEvalString("drawnow;");
...
//************************************** FIND THE DECISION GRAPH ********************************************// 
 ...
 //mexPrintf("computing decision graph  \n");
 //mexEvalString("drawnow;");
...
#pragma omp for schedule (dynamic,CHUNK) 
 ...
 // it arbitrarily defines "minimum distance from a point with higher density" for the absolute maximum of density
